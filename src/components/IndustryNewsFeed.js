...
const NEWS_DATA = [
  // ══════════════════════════════════════════════════════
  // 2026-05-18（第49轮更新 — 大模型商业化转折点/Grok 1.5万亿/Google I/O开幕/通义千问新模型预告）
  // ══════════════════════════════════════════════════════
  {
    id: 2814,
    category: 'market',
    region: 'global',
    title: 'Anthropic 年化收入突破 440 亿美元，同比增长 80 倍，五角大楼合同被排除',
    summary: 'Anthropic 披露第一季度 ARR 突破 440 亿美元（同比+80 倍），企业客户超 15 万家。但五角大楼签署 AI 合作协议时明确排除 Anthropic，因双方存在未决诉讼。商业成功与政府信任之间的裂痕加深。',
    source: '路透社/金融时报',
    date: '2026-05-18',
    tags: ['Anthropic', 'ARR', '收入', '五角大楼', '政府合同'],
    hot: true,
  ...
  },
  {
    ...
    category: 'hardware',
    region: 'global',
    title: '马斯克确认 Grok 1.5 万亿参数模型完成训练，将吸收 Cursor 编程数据补短板',
    summary: 'Elon Musk 确认 xAI 第 9 版 Grok 基础模型完成训练，参数量 1.5 万亿——目前全球最大。为弥补编程短板将专门吸收 Cursor 代码数据并辅以 SFT+RL 精调。预计 3-4 周内向公众发布。',
    source: 'X/TechCrunch',
    date: '2026-05-18',
    tags: ['xAI', 'Grok', '1.5万亿', '编程', 'Musk'],
    hot: true,
    link: 'https://x.com/',
  },
  {
    ...
    category: 'cloud',
    region: 'global',
    title: 'Google I/O 2026 开幕：Gemini 4.0、Aluminium OS、AR 眼镜三大核心发布',
    summary: '2026 Google I/O 于 5/19-20 举行，三大看点：Gemini 4.0 逻辑推理大提升+传闻 Omni 多模态版；Aluminium OS 全新 AI 优先桌面平台；AR 眼镜「金珠」379-499 美元主打实时语音交互。',
    source: 'Google 官方/The Verge',
    date: '2026-05-18',
    tags: ['Google', 'I/O 2026', 'Gemini 4.0', 'Aluminium OS', 'AR眼镜'],
    hot: true,
  ...
  },
  {
    ...
    category: 'cloud',
    region: 'china',
    title: '通义千问预告重量级新模型 5/20 阿里云峰会亮相，通义全栈升级',
    summary: '阿里云通义千问宣布全新模型将于 5/20 阿里云峰会亮相，官方称将在全能性、模型能力和深度上全面升级。当前国产大模型竞争白热化，通义此举旨在巩固企业级云服务 AI 生态。',
    source: '阿里云官方',
    date: '2026-05-18',
    tags: ['通义千问', '阿里云', '新模型', '国产AI', '企业AI'],
    hot: true,
  ...
  },
  {
    ...
    category: 'market',
    region: 'china',
    title: '大模型周调用量中国连续三周超美国，Hy3 和 DeepSeek 领跑全球',
    summary: 'OpenRouter 最新数据：5/11-17 中国周调用量 7.693 万亿 Token，是美国（4.24 万亿）的 1.81 倍。腾讯 Hy3preview（2.66 万亿，环比+210%）和 DeepSeek-V4-Flash 分列全球前二。',
    source: 'OpenRouter/每日经济新闻',
    date: '2026-05-18',
    tags: ['中国AI', '调用量', 'Hy3', 'DeepSeek', 'Token'],
    hot: true,
  ...
  },
  {
    ...
    category: 'hardware',
    region: 'global',
    title: 'NVIDIA 发布 SANA-WM 26 亿参数世界模型：文本生成 1 分钟 720p 视频',
    summary: 'NVIDIA 发布 SANA-WM 世界模型，仅 26 亿参数可从文本生成最长 1 分钟 720p 视频。采用扩散 Transformer 架构，物理一致性表现优异，参数量远低于 Sora 等同类模型。',
    source: 'NVIDIA Research',
    date: '2026-05-16',
    tags: ['NVIDIA', 'SANA-WM', '世界模型', '视频生成'],
    hot: true,
  ...
  },
  {
    ...
    category: 'startup',
    region: 'china',
    title: '字节跳动 2026 年 AI 资本开支预计超 2000 亿元，阿里「远超 3800 亿」',
    summary: '浙商证券研报披露字节跳动今年 AI 资本开支超 2000 亿元（GPU+数据中心），阿里 CEO 明确未来 AI 开支「远超 3800 亿」。两家合计接近 6000 亿，中国科技巨头 AI 军备竞赛全面升级。',
    source: '浙商证券/36氪',
    date: '2026-05-15',
    tags: ['字节跳动', '阿里巴巴', 'AI投入', '资本开支', '算力'],
    hot: true,
    link: 'https://36kr.com/',
  },
  {
    ...
    category: 'security',
    region: 'global',
    title: 'Linus Torvalds 表示 Linux 安全邮件列表因 AI 漏洞猎人「几乎无法管理」',
    summary: 'Torvalds 公开表示 Linux 内核安全邮件列表因 AI 驱动的自动漏洞猎人提交大量低质量和重复报告而几乎无法管理。敦促研究人员创建实际补丁增加价值而非依赖 AI 批量生成。',
    source: 'Linux 邮件列表/ZDNet',
    date: '2026-05-18',
    tags: ['Linux', 'Torvalds', 'AI漏洞', '安全', '开源'],
    hot: true,
    link: 'https://lwn.net/',
  },
  {
    ...
    category: 'cloud',
    region: 'global',
    title: '谷歌发布「Googlebook」AI 优先笔记本，运行 Aluminium OS，秋季上市',
    summary: '谷歌在 I/O 前夕发布 Googlebook——专为 Gemini 设计的 AI 优先笔记本，运行全新 Aluminium OS 系统，具备「魔法指针」「创建我的组件」「投射我的应用」等创新交互，对标苹果 MacBook。',
    source: 'Google 官方',
    date: '2026-05-13',
    tags: ['Google', 'Googlebook', 'AI笔记本', 'Aluminium OS', '硬件'],
    hot: true,
  ...
  },
  {
    ...
    category: 'cloud',
    region: 'global',
    title: '谷歌 Android 17 发布前瞻：Gemini 智能体深度系统级集成',
    summary: 'Android Show 上预览 Android 17，最大亮点是 Gemini 系统级集成——长按电源键让 AI 跨应用操作手机（比价打车/预定餐厅等）。同时 Claude Platform on AWS 正式可用，企业可 IAM 鉴权使用。',
    source: 'Google Android 官方',
    date: '2026-05-12',
    tags: ['Google', 'Android 17', 'Gemini', 'AI Agent'],
    hot: true,
  ...
  },
  {
    ...
    category: 'software',
    region: 'global',
    title: 'Meta 裁员 8000 人（10%），重组为「Meta 超级智能实验室」聚焦 AGI',
    summary: 'Meta 宣布裁员约 8000 人，作为公司重组为 Meta 超级智能实验室的一部分，整合 FAIR 和 GenAI 团队聚焦 AGI 研发。同期被曝使用员工计算机活动数据训练 AI 引发内部争议。',
    source: 'The Verge/华尔街日报',
    date: '2026-05-08',
    tags: ['Meta', '裁员', '超级智能', 'AGI', '重组'],
    hot: true,
  ...
  },
  {
    ...
    category: 'startup',
    region: 'china',
    title: '月之暗面完成 136 亿元 D 轮融资，创中国大模型单笔融资纪录',
    summary: '月之暗面（Kimi）完成约 136.22 亿元 D 轮融资，阿里领投，红杉高瓴跟投，创中国大模型领域单笔融资纪录。此前 DeepSeek 也传出 450 亿美元估值融资消息，中国大模型融资白热化。',
    source: '36氪',
    date: '2026-05-07',
    tags: ['月之暗面', 'Kimi', '融资', 'D轮', '中国AI'],
    hot: true,
    link: 'https://36kr.com/',
  },
  {
    ...
    category: 'software',
    region: 'global',
    title: 'Y Combinator 披露持有 OpenAI 0.6% 股份，价值超 50 亿美元',
    summary: 'Y Combinator 在 Demo Day 披露持有 OpenAI 约 0.6% 股份，按最新估值超 50 亿美元，为 YC 史上最成功投资。YC 合伙人表示这笔收益将用于支持更多 AI 创业公司。',
    source: 'TechCrunch',
    date: '2026-05-07',
    tags: ['OpenAI', 'Y Combinator', '投资', '估值'],
    hot: true,
  ...
  },
  {
    ...
    category: 'cloud',
    region: 'global',
    title: 'GPT-5.5 Pro 获菲尔兹奖得主评测：数学推理达研究生水平',
    summary: '菲尔兹奖得主 Timothy Gowers 深度评测 GPT-5.5 Pro：本科数学正确率 92%，研究生级别 67%。Gowers 认为 AI 将成为数学研究的「超级助手」而非替代者。同期 GPT-5.5 涨价引发开发者成本担忧。',
    source: 'Nature',
    date: '2026-05-09',
    tags: ['GPT-5.5', '数学', '菲尔兹奖', '评测', '定价'],
    hot: true,
  ...
  },
  {
    ...
    category: 'security',
    region: 'global',
    title: 'Mozilla 利用 Claude Mythos 预览版加固 Firefox，发现 12 个未公开漏洞',
    summary: 'Mozilla 披露使用 Anthropic 未公开的 Claude Mythos 模型预览版强化 Firefox 安全检测，在代码库中发现 12 个此前未被注意的安全漏洞。展示前沿 AI 在主动安全防御领域的巨大潜力。',
    source: 'Mozilla 安全博客',
    date: '2026-05-09',
    tags: ['Mozilla', 'Claude Mythos', 'Firefox', '安全', '漏洞'],
    hot: false,
    link: 'https://blog.mozilla.org/security/',
  },
  {
    id: 2829,
    category: 'software',
    region: 'global',
    title: '哈佛试验：OpenAI o1 模型诊断准确率 67% 超医生 50-55%',
    summary: '哈佛医学院在真实急诊场景的对照试验显示 OpenAI o1 模型急诊诊断准确率 67%，高于人类医生 50-55%。在鉴别诊断、罕见病识别和用药建议等维度均优于医生平均水平。',
    source: '哈佛医学院/NEJM',
    date: '2026-05-04',
    tags: ['OpenAI', '医疗AI', 'o1', '诊断', '临床验证'],
    hot: true,
