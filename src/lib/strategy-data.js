...
export const SITE_ROADMAP = {
  ...
  topOpportunities: [
    {
      ...
      value: '高',
      effort: '低',
      desc: 'OpenAI Workspace Agents、Google Agent Platform、AWS Bedrock Agents、Microsoft Copilot Studio 四大平台同步发力，企业 Agent 是 2026 年最热赛道。Signal 需系统化追踪。',
      action: '声浪 agent category 加强追踪；工具箱考虑新增「企业 Agent 平台对比」Tab',
      color: '#6c5ce7',
    },
    {
      ...
      value: '高',
      effort: '中',
      desc: 'Qwen3、DeepSeek、InternLM 系列已进入全球第一梯队。Qwen3.6-27B 证明小参数密集模型路线可行。Signal 对国产模型的覆盖需从零散追踪升级为系统化专题。',
      action: '模型库优先补充 Qwen3 系列；声浪 llm category 加强国产模型追踪',
      color: '#fd79a8',
    },
    {
      id: 'agent-memory-infra',
      title: 'Agent 记忆与基础设施工具',
      priority: 'P0',
      value: '高',
      effort: '中',
      desc: 'cognee（Agent 记忆引擎）、openai-agents-python（多 Agent 框架）、mem0 等工具快速崛起。Agent 基础设施是当前最大的内容空白。',
      action: '声浪 agent category 新增记忆/框架方向；工具箱考虑新增「Agent 基础设施」分类',
      color: '#ffa657',
    },
    {
      id: 'global-search',
    ...
    {
      id: 'github-trending-tracking',
      title: 'GitHub Trending AI 追踪',
      priority: 'P1',
      value: '高',
      effort: '低',
      desc: 'GitHub trending 是发现新兴 AI 工具/框架的最佳渠道。modelcontextprotocol/servers(14k⭐)、markitdown(40k⭐)、LLaMA-Factory(40k⭐) 等高价值仓库均从此发现。',
      action: '声浪新增 github category，采集员定期抓取 AI 相关 trending 仓库',
      color: '#00cec9',
    },
  ],
  ...
  // 新闻角度盲区（仅保留未覆盖的方向）
  coverageGaps: [
    { angle: '企业 Agent 平台竞争', severity: '严重缺失', hotness: '🔥🔥🔥', suggestedCategory: 'agent', suggestedSources: ['OpenAI 企业博客', 'Google Cloud Blog'] },
    { angle: 'Agent 记忆/知识引擎', severity: '严重缺失', hotness: '🔥🔥🔥', suggestedCategory: 'agent', suggestedSources: ['cognee GitHub', 'mem0 Blog'] },
    { angle: '国产开源模型进展', severity: '覆盖不足', hotness: '🔥🔥🔥', suggestedCategory: 'llm', suggestedSources: ['qwenlm.github.io', '智源研究院'] },
    { angle: 'AI 硬件/芯片', severity: '覆盖不足', hotness: '🔥🔥', suggestedCategory: 'infra', suggestedSources: ['Groq', 'Cerebras', '寒武纪'] },
    { angle: '端侧/小模型', severity: '覆盖不足', hotness: '🔥🔥', suggestedCategory: 'infra', suggestedSources: ['Apple ML Research', 'Microsoft Research'] },
  ],
  ...
  moduleProposals: [
    {
      ...
      effort: '中',
      value: '高',
      desc: 'OpenAI / Google / AWS / Microsoft 四大企业 Agent 平台横向对比',
      dataSource: '各平台官方文档 + 社区评测',
      implementHint: '工具箱新增 Tab，参考现有对比矩阵实现',
    },
    {
      name: 'Agent 基础设施工具目录',
      type: '工具/实践类',
      ...
      effort: '低',
      value: '高',
      desc: '记忆引擎（cognee/mem0）、框架（openai-agents/LangGraph/CrewAI）、评测（AgentBench）',
    ...
    },
    {
      ...
      effort: '低',
      value: '高',
      desc: '每日/每周 AI 相关仓库 trending 自动追踪',
      dataSource: 'github.com/trending',
      implementHint: '声浪新增 github category，采集员定期抓取',
    },
    {
      name: 'HF 每日论文',
      type: '学术/研究类',
  ...
  suggestedSources: [
    ...
    { name: 'Google Cloud Blog', url: 'https://cloud.google.com/blog/products/ai-machine-learning', type: '企业博客', reason: 'Google 全栈 AI 布局一手信息' },
