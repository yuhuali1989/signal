...
class ModelRouter:
    ...
    def __init__(self):
        self.models = [
            {"name": "gpt-4o", "priority": 1, "healthy": True},
            {"name": "claude-3-opus-20240229", "priority": 2, "healthy": True},
...
### GPT-4o 原生多 Agent：编排框架的价值重估

OpenAI 发布 GPT-4o API GA 版本，关键特性是「**原生多 Agent 编排**」—— 单次 API 调用可以自主派发子任务给不同专家模型。这对 LangChain / CrewAI / AutoGen 等编排框架带来结构性挑战：
