...
2026 年 4 月 20 日，Vercel 确认其内部系统通过被入侵的第三方 AI 编码工具被非授权访问。这是**首起通过 AI Agent 工具链入侵头部云平台**的真实事件，凸显了多 Agent 系统中供应链攻击的新型风险：
...
### 4. Claude Opus 4.7 的 Agent 模式增强

Anthropic Claude Opus 4.7（2026-04-16）新增 `xhigh` 推理强度等级，专为复杂 Agent 任务设计：
