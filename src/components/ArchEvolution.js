...
const TIMELINE = [
  ...
  { date: '2026-04', model: 'Google Gemma 4（31B / 26B MoE）', innovation: 'Multi-Token Prediction K=4（全系列统一）+ 原生多模态 + 256K 超长上下文', contribution: '首次在完整系列（2B→31B）统一采用 MTP K=4：训练时同时预测 4 个 future token（λ=1/0.5/0.25/0.125），推理时 Speculative Decoding 2.7× 加速；原生视频/图像/音频多模态，256K 上下文，140+ 语言；31B LMArena 超闭源同级，Apache 2.0', tag: 'MTP+多模态', color: 'bg-green-100 text-green-700' },
