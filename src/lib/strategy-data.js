...
export const SITE_ROADMAP = {
  ...
  summary: '✅ P0 三项已实施：MCP Server 目录（工具箱新 Tab）、GitHub Trending 追踪（声浪新 category）、HF 每日论文（论文模块新分类）。当前 P1 优先级：AI 安全/对齐专题 + AI 编程工具对比矩阵。',
  ...
  topOpportunities: [
    {
      ...
      value: '高',
      effort: '低',
      desc: '✅ 已实施（2026-04-22）：工具箱新增「MCP 目录」Tab，收录 14 个官方 + 社区精选 Server，支持分类筛选。',
      action: '持续更新：关注 modelcontextprotocol/servers 新增 Server，每月同步一次',
      color: '#00b894',
    },
    {
      id: 'github-trending',
      ...
      value: '高',
      effort: '低',
      desc: '✅ 已实施（2026-04-22）：声浪新增「GitHub 热榜」category，加入 5 条本周 Trending 条目（browser-use/unsloth/markitdown/AutoGPT/MCP）。',
      action: '持续更新：采集员每周抓取 GitHub Trending AI 类仓库，加入声浪 github category',
      color: '#00b894',
    },
    {
      id: 'hf-daily-papers',
      ...
      value: '高',
      effort: '低',
      desc: '✅ 已实施（2026-04-22）：论文模块新增「HF 精选」分类，加入 5 篇 HF Daily Papers 精选（Kimi-VL/Qwen3/Phi-4-reasoning/Gemini 2.5/Llama 4）。',
      action: '持续更新：采集员每周从 huggingface.co/papers 抓取高赞论文，加入 hf-picks 分类',
      color: '#00b894',
    },
    {
      ...
      value: '高',
      effort: '中',
      desc: 'AI 安全是当前最热门的研究方向之一，Signal 声浪 6 个 category 中完全缺失该角度（已有 safety category 但内容稀少）。',
      action: '声浪 safety category 补充内容，信息源加入 Anthropic 安全博客 / AI Safety Institute / METR',
      color: '#e17055',
    },
    {
      id: 'ai-coding-tools',
      ...
      value: '高',
      effort: '中',
      desc: 'Cursor / Copilot / Windsurf / Devin 等工具用户决策需求强烈，目前无横向对比模块。SpaceX 收购 Cursor 事件进一步提升了该方向的关注度。',
      action: '在「工具」页面新增 AI 编程工具对比矩阵 Tab，定期更新功能/定价/适用场景',
      color: '#ffa657',
    },
  ],
