...
- ✅ 时间分组规则：最近 7 天按日、2026 年按周、2025 年按月、2024 及更早按年
- ✅ 历史数据补充：含 2024-2026 年各阶段汇总条目（日/周/月/季/年汇总）
- ✅ 汇总条目有 📋 汇总标签，视觉上与单条新闻区分
- ✅ 筛选器：6 大分类（AI/软件/游戏/硬件/创业融资/政策监管）+ 地区（国内/国际）+ 仅看热点
- ✅ 滚动时时间轴自动高亮当前时间段
...
*最后更新：2026-04-18（导航名「数据闭环」改为「闭环 Infra」）*
