...
- 📊 **甘特图：业务成果×招聘节奏×招聘投入（三轨并行）**：
  ...
  - 累计总人数行：18→52→75→95→110→...→248 人（预留 12 人 buffer 至满编 260）
  - 招聘节奏策略：7月核心骨干紧急到位→Q3-Q4执行层补齐→2027方向扩展→2028平台成熟→2029商业化→2030全球化
  - 6 个关键招聘里程碑卡片（紧急启动/快速补齐/稳步扩充/方向扩展/深度补强/商业化），每个标注招聘成本
