...
- ✅ **8 大 Tab**（原 4 Tab 保留并深化，新增 4 条深度支线）：
  ...
  - 🗺️ **AI 战略规划**（新增）：**平安银行金融 AI 战略部五年业务规划（2026-2030）**——部门使命/愿景 + 五年演进路线（Y1 筑基→Y2 场景突破→Y3 Agent 驱动→Y4 生态输出→Y5 AI 原生银行）+ **人力成本精细拆解**（85→250 人，8 大岗位族群：ML/算法研究 + 工程开发 + 产品/业务分析 + 测试/QA + 数据标注/分析 + 合规/风控 + PMO/项目管理 + 运维/SRE，Y4-Y5 新增解决方案/售前团队；算法:工程 ≈ 1:2.3~2.5 体现银行重落地特点；每岗位拆解为基本工资/绩效奖金(0-8个月)/股权RSU/综合福利(五险一金+商业保险+工位租金3-5万+餐补交通2-3万+团建差旅)，P8+ 专家 250 万起/P9 级 400-500 万/首席科学家 600 万+，五年人力合计约 ¥9.9 亿）+ **🆕 人员细分二级展开**（每个岗位可点击展开查看子角色明细：岗位名称/级别标签/人数/年包/核心职责列表/🤖 AI 赋能方式；如 ML/算法研究 12 人细分为首席算法专家 P8+ ×1 + 高级算法工程师 P8 ×2 + 算法工程师 P7 ×5 + 初级算法工程师 P6 ×4，每人标注具体职责和 AI 如何提效；工程开发 30 人细分为 AI 平台架构师 + AI 平台工程师 + 数据工程师 + 后端工程师 + 前端工程师等，标注"CRUD 代码 90% AI 生成""组件代码 80% AI 生成"等 AI 时代工作方式）+ **硬件基础设施预算明细**（GPU训练/推理集群+存储+网络+隐私计算+灾备等 8 项，含规格/占比/说明，五年合计约 ¥3.4 亿）+ **外部采购明细**（国产大模型私有化部署授权+隐私计算+数据源+咨询审计+培训 5 项，**合规要求：银行数据不可出境，禁止调用境外商业模型 API，统一采用文心一言/通义千问/GLM 企业版私有化部署**）+ **营收&节省成本精细拆解**（每项含计算公式+置信度标注，节省成本=人力替代+损失降低，增量营收=佣金+服务费+SaaS+解决方案）+ **四大业务线目标拆解**（风控/客服/理财/合规，每条线 5 年里程碑 + 核心指标 baseline→target）+ **ROI 测算总表**（年度/累计 ROI 自动计算 + 可视化条形图）+ **关键风险与应对**（5 大风险 + 影响/应对策略）+ **组织架构**（Y3 成熟态 8 个小组 180 人编制）+ 人力/营收明细支持展开/收起交互 + 人员细分支持二级展开/收起
...
- 🏦 **金融业务-战略模块重构**：从"上来就 12 个 ML 算法"改为"业务视角出发"的正确逻辑：
  - 新增「业务目标与半年产出节点」：4 大业务线 × 10 个半年 Milestone，每个节点有明确的可交付产出、业务成果、收入/节省
  - 新增「工作量拆解」：从产出反推人月（5 年 × 5 条业务流 × 具体任务），Y1=1020 人月 → Y5=3120 人月
  - 新增「人力需求推导」：工作量 ÷ 有效工作月(10.2) ÷ AI 提效系数 → 实际人数，清晰展示"为什么 AI 时代人力比传统少 30-50%"
  - 展示顺序调整为：业务目标 → 半年产出 → 工作量 → 人力需求 → 人力预算 → 物力预算 → 管理预算 → ROI
- 📊 **甘特图：业务成果×招聘节奏双轨并行**：
  - 上半部分：5 条业务线甘特条（风控/客服/理财/合规/AI平台），展示五年可交付产出时间跨度
  - 下半部分：9 个部门半年招聘人数柱状图（ML/工程/产品/测试/合规/PMO/运维/数据/售前）
  - 累计总人数行：52→85→130→170→207→248 人（预留 12 人 buffer 至满编 260）
  - 招聘节奏策略：26H1 核心骨干→26H2 执行层→27 方向扩展→29 商业化团队→30 全球化
  - 4 个关键招聘里程碑卡片（紧急/快速/扩展/商业化），标注当前时间位置
