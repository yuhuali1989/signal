...
const NEWS_DATA = [
  ...
  },
  {
    ...
    category: 'industry',
    region: 'china',
    title: '国产 AI 搜索出海提速：腾讯 QClaw 海外版上线，与 Perplexity 正面交锋',
    summary: '腾讯 QClaw 海外版正式上线，成为继字节 Doubao、百度文心之后又一出海的国产 AI 产品。国内 AI 搜索赛道正在从"国内竞争"转向"全球竞争"，Perplexity（估值 $9B）成为主要对标对象。分析师指出，国产 AI 出海的核心壁垒在于英文语料质量和海外用户信任度，而非技术本身。腾讯的搜索基础设施和全球化经验（微信海外版）是其差异化优势。',
    source: 'AIbase 日报',
    date: '2026-04-27',
    tags: ['腾讯', 'AI搜索', '出海', '全球化'],
    hot: false,
  ...
  },
  {
    ...
    category: 'industry',
    region: 'global',
    title: 'AI 设计工具商业化加速：Claude Design 入场，设计师职业迎来结构性冲击',
    summary: 'Anthropic 推出 Claude Design，加入 Figma AI、Adobe Firefly、Canva AI 的竞争行列。AI 设计工具正在从"辅助生成"升级为"自主设计"——设计师只需描述需求，AI 完成从线框图到可交付组件的全流程。设计行业分析师警告：初级 UI/UX 设计岗位将在 2-3 年内大幅萎缩，但"AI 设计导演"（负责审核和方向把控）的需求将上升。',
    source: 'Anthropic',
    date: '2026-04-27',
    tags: ['AI设计', 'Anthropic', '职业冲击', '创意工具'],
    hot: true,
  ...
  },
  {
    ...
    category: 'industry',
    region: 'global',
    title: 'AI 编码评测体系失效：SWE-bench 饱和，软件工程师如何重新定义"AI 能力"',
    summary: 'SWE-bench Verified 被顶尖模型刷满（Claude Opus 4.7 达 87.6%），业界开始质疑现有评测体系的有效性。这一危机折射出更深层的行业问题：当 AI 能完成大多数"标准"编程任务，软件工程师的核心价值将转向系统设计、需求理解和 AI 监督。多家科技公司已开始调整招聘标准，从"会写代码"转向"会用 AI 写更好的代码"。',
    source: 'Hacker News',
    date: '2026-04-27',
  ...
  },
  {
    ...
    category: 'industry',
    region: 'china',
    title: 'Kimi K2.6 发布引发长上下文赛道竞争：企业级文档处理需求成新战场',
    summary: '月之暗面 Kimi K2.6 发布，长上下文能力再升级。长上下文模型正在重塑企业级文档处理市场——法律合同审查、财务报告分析、技术文档问答等场景，原本需要专业人员数天完成的工作，现在可以在分钟级完成。国内已有多家律所和会计师事务所开始试点 Kimi 长上下文方案，替代部分初级分析师工作。',
    source: 'AIbase 日报',
    date: '2026-04-27',
  ...
  // ══════════════════════════════════════════════════════
  // 2026-04-26（第34轮更新 — AI图像生成商业化 / 谷歌云反攻 / AI研究工具颠覆知识工作 / 国产轻量模型竞争 / AI助手平台化）
  // ══════════════════════════════════════════════════════
  {
    id: 2723,
    category: 'industry',
    region: 'global',
    title: 'ChatGPT Images 2.0 冲击创意产业：Midjourney 和 Adobe 面临平台级竞争',
    summary: 'OpenAI 将图像生成能力深度集成进 ChatGPT，ChatGPT Images 2.0 支持对话式图像创作和精准文字渲染。这对 Midjourney（估值 $10B）和 Adobe Firefly 构成直接威胁——用户无需切换工具，在同一对话中即可完成文字+图像的混合创作。广告、设计、出版行业的工作流将被重构，"提示词工程师"正在成为创意行业的新职位。',
    source: 'AIbase 日报',
    date: '2026-04-26',
    tags: ['OpenAI', '图像生成', '创意产业', 'Midjourney'],
    hot: true,
    link: 'https://www.aibase.com/zh/daily',
  },
  {
    ...
    category: 'industry',
    region: 'global',
    title: '谷歌云 AI 战略奏效：2026 Q1 增速超越 AWS，AI 工作负载成云计算新增长极',
    summary: '谷歌云 2026 Q1 营收增速首次超过 AWS，分析师将其归因于 Gemini 生态的企业渗透和 TPU 硬件的成本优势。这标志着 AI 工作负载正在成为云计算市场的核心增长驱动力，而非传统的存储和计算。企业 CTO 调查显示，超过 60% 的企业正在将 AI 训练和推理工作负载迁移到云端，谷歌的 Vertex AI + Gemini 组合成为 AWS SageMaker 的有力竞争者。',
    source: 'Hacker News',
    date: '2026-04-26',
    tags: ['谷歌云', 'AWS', '云计算', 'AI工作负载'],
    hot: true,
    link: 'https://news.ycombinator.com/',
  },
  {
    ...
    category: 'industry',
    region: 'global',
    title: 'AI 深度研究工具颠覆咨询行业：Gemini 3.1 Pro 代理可替代初级分析师',
    summary: 'Gemini 3.1 Pro 深度研究代理上线，能在数小时内完成原本需要初级分析师 2-3 天的研究报告。麦肯锡、BCG 等顶级咨询公司已开始内部测试 AI 研究工具，部分公司宣布将减少初级分析师招聘。与此同时，"AI 研究监督员"新职位正在兴起——负责验证 AI 研究结论的准确性和商业可用性。知识工作的价值链正在从"信息收集"转向"判断与决策"。',
    source: 'Google Blog',
    date: '2026-04-26',
    tags: ['咨询行业', 'AI研究', '知识工作', '职业变革'],
    hot: true,
  ...
  },
  {
    ...
    category: 'industry',
    region: 'china',
    title: '国产轻量模型竞争白热化：百灵 Ling-2.6-flash 加入低延迟赛道，边缘计算场景受益',
    summary: '百灵 Ling-2.6-flash 发布，与 DeepSeek-V4 flash、Qwen3.6-27B 共同构成国产轻量模型三强格局。低延迟轻量模型正在成为边缘计算、IoT 设备和实时交互场景的核心基础设施。工业互联网、智能制造、车载系统等场景对毫秒级响应的需求，正在推动轻量模型市场快速扩张。国内云厂商（阿里云、腾讯云、华为云）纷纷将轻量模型作为边缘 AI 服务的核心卖点。',
    source: 'AIbase 日报',
    date: '2026-04-26',
    tags: ['轻量模型', '边缘计算', '工业互联网', '国产AI'],
    hot: false,
    link: 'https://www.aibase.com/zh/daily',
  },
  {
    ...
    category: 'industry',
    region: 'global',
    title: 'Perplexity Mac 助手挑战 Apple Intelligence：AI 助手平台化竞争进入白热化',
    summary: 'Perplexity 推出 Mac 端原生助手，直接挑战苹果 Apple Intelligence 的系统级 AI 地位。这场竞争的本质是"AI 助手入口之争"——谁能成为用户日常工作的默认 AI 助手，谁就能获得最有价值的用户行为数据。微软（Copilot）、谷歌（Gemini）、Anthropic（Claude）、Perplexity 四方混战，苹果的护城河在于硬件生态和隐私承诺，但 Perplexity 的搜索能力和实时信息优势正在侵蚀这一壁垒。',
    source: 'AIbase 日报',
    date: '2026-04-26',
    tags: ['AI助手', 'Apple', 'Perplexity', '平台竞争'],
    hot: false,
    link: 'https://www.aibase.com/zh/daily',
  },
  // ══════════════════════════════════════════════════════
