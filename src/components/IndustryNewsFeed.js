...
const NEWS_DATA = [
  // ══════════════════════════════════════════════════════
  // 2026-04-29（第37轮更新 — Qwen3全系列开源 / 微软Build预告 / Claude 4降价 / 豆包降价80% / Llama 4 Scout开源 / 数据要素流通指引）
  // ══════════════════════════════════════════════════════
  {
    id: 2743,
    category: 'industry',
    region: 'china',
    title: 'Qwen3 全系列开源：235B MoE 旗舰登顶开源榜，阿里云重夺开源大模型话语权',
    summary: '阿里云开源 Qwen3 全系列，235B-A22B MoE 旗舰在 AIME 2025、LiveCodeBench 等多项基准上超越 DeepSeek-R1 和 GPT-4.1，成为开源最强。「思考/非思考双模式」是最大亮点——同一模型通过参数切换深度推理与快速响应，无需部署两套模型。对行业的影响是：开源模型能力已接近闭源旗舰，API 商业化的价值主张正在被重新审视。',
    source: '阿里云官博',
    date: '2026-04-29',
    tags: ['Qwen3', '阿里云', 'MoE', '开源', '思考模式'],
    hot: true,
  ...
  },
  {
    ...
    category: 'software',
    region: 'global',
    title: '微软 Build 2026 预告：Copilot+ PC 接入 GPT-5.5，端侧 AI 进入旗舰时代',
    summary: '微软宣布将在 Build 2026 大会（5 月）发布 Copilot+ PC 新一代能力，核心是将 GPT-5.5 推理能力下沉到端侧，通过 NPU + 云端混合推理实现「离线可用、联网增强」。Windows AI Studio 同步升级，支持本地微调 Phi-4 和 Qwen3 系列。这是微软将 AI 能力从云端向端侧全面延伸的关键一步，PC 厂商将迎来新一轮 AI 硬件升级周期。',
    source: '微软官博',
    date: '2026-04-29',
    tags: ['微软', 'Copilot+', '端侧AI', 'Build 2026'],
    hot: true,
  ...
  },
  {
    ...
    category: 'market',
    region: 'global',
    title: 'Anthropic Claude 4 系列发布：Sonnet 4 编码超越 Opus 3.7，定价下调 40%',
    summary: 'Anthropic 发布 Claude 4 系列，Sonnet 4 在 SWE-bench Verified 上达到 72.7%，超越上一代旗舰 Opus 3.7，同时 API 定价下调 40%。「扩展思考 v2」支持推理过程中调用工具和搜索网络，形成「思考-行动-再思考」的 Agent 循环。这是 Anthropic 在 OpenAI 降价压力下的主动出击，也是 AI API 市场价格战进入新阶段的信号。',
    source: 'Anthropic 官博',
    date: '2026-04-29',
    tags: ['Anthropic', 'Claude 4', '降价', '编码', 'Agent'],
    hot: true,
  ...
  },
  {
    ...
    category: 'market',
    region: 'china',
    title: '字节豆包 API 降价 80%：国内大模型价格战进入「分厘时代」，行业整合预期增强',
    summary: '字节跳动豆包系列大模型 API 全线降价 80%，主力模型 Doubao-pro-32k 降至 0.16 元/百万 token。继阿里、腾讯之后，国内主流模型 API 价格已普遍低于 0.2 元/百万 token。价格战加速了 AI 应用层的爆发，但也压缩了中小模型厂商的生存空间——没有规模效应支撑的模型厂商将面临生存危机，行业整合预期增强。',
    source: 'IT之家',
    date: '2026-04-29',
    tags: ['字节跳动', '豆包', '降价', '价格战', '行业整合'],
    hot: true,
  ...
  },
  {
    ...
    category: 'industry',
    region: 'global',
    title: 'Meta 开源 Llama 4 Scout 17B：10M 上下文 + 单卡可跑，开源多模态旗舰刷新标杆',
    summary: 'Meta 开源 Llama 4 Scout 17B（17B 激活参数，109B 总参数），支持 10M token 超长上下文，是目前开源模型中上下文窗口最长的。原生多模态输入，单张 H100 可完整运行。同步发布 Maverick 400B MoE 版本。Llama 4 的发布进一步压缩了闭源模型的差异化空间，开源生态正在成为 AI 应用层创新的主战场。',
    source: 'Meta AI 官博',
    date: '2026-04-29',
    tags: ['Meta', 'Llama 4', '开源', '多模态', '长上下文'],
    hot: true,
  ...
  },
  {
    ...
    category: 'industry',
    region: 'china',
    title: '国家数据局发布《AI 数据要素流通指引》：数据资产入表，合成数据使用比例受限',
    summary: '国家数据局发布《人工智能数据要素流通指引（2026 版）》，首次将「AI 训练数据集」纳入数据资产入表范畴，并限制合成数据使用比例（不超过 40%）。这是中国 AI 数据治理从监管框架走向可操作规则的重要一步，对数据要素市场（数据交易所、数据经纪商）是重大利好，对依赖合成数据训练的 AI 公司则构成合规压力。',
    source: '国家数据局官网',
    date: '2026-04-29',
    tags: ['数据要素', 'AI监管', '数据资产', '合规'],
    hot: false,
  ...
  },
  {
    ...
    summary: 'Cognition AI（Devin 开发商）完成 $2.5 亿 B 轮融资，估值升至 $25 亿。Devin 2.0 在 SWE-bench 上的表现已接近人类初级工程师水平，企业客户数量超过 500 家。这是 AI 软件工程师赛道的重要里程碑，也是 AI Agent 从"工具"走向"同事"的商业化验证。对传统软件外包行业（Infosys/Wipro/Accenture）构成长期威胁。',
    source: 'TechCrunch',
    date: '2026-04-29',
    tags: ['Cognition AI', 'Devin', 'AI工程师', '融资', 'Agent'],
    hot: true,
