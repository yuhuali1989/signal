...
//   - DataFile 行数 < 10万: BF 收益有限，可不开`,
    ...
    // ── 文件格式对比矩阵 ──
    fileFormatMatrix: [
      { dim: '存储模式',   parquet: '列式',     orc: '列式',     avro: '行式',     arrow: '列式内存', json: '行式文本', csv: '行式文本' },
      { dim: '压缩率',     parquet: '⭐⭐⭐⭐⭐', orc: '⭐⭐⭐⭐⭐', avro: '⭐⭐⭐',   arrow: '⭐⭐',     json: '⭐',       csv: '⭐' },
      { dim: '列裁剪',     parquet: '✅',        orc: '✅',        avro: '❌',       arrow: '✅',       json: '❌',       csv: '❌' },
      { dim: '谓词下推',   parquet: '✅ RowGroup', orc: '✅ Stripe', avro: '❌',      arrow: '✅ SIMD',  json: '❌',       csv: '❌' },
      { dim: '流式写入',   parquet: '❌',        orc: '❌',        avro: '✅',       arrow: '✅',       json: '✅',       csv: '✅' },
      { dim: 'Schema 演化', parquet: '✅',       orc: '✅',        avro: '✅ 最强',  arrow: '✅',       json: '✅ 灵活',  csv: '❌' },
      { dim: '人类可读',   parquet: '❌',        orc: '❌',        avro: '❌',       arrow: '❌',       json: '✅',       csv: '✅' },
      { dim: 'Spark 支持', parquet: '✅ 最优',   orc: '✅',        avro: '✅',       arrow: '✅',       json: '✅',       csv: '✅' },
      { dim: 'Kafka 集成', parquet: '❌',        orc: '❌',        avro: '✅ 标准',  arrow: '⚠️',       json: '✅',       csv: '❌' },
      { dim: 'ML 训练',    parquet: '✅ 主流',   orc: '⚠️',        avro: '❌',       arrow: '✅ 最优',  json: '⚠️ 小数据', csv: '❌' },
      { dim: '湖仓数据文件', parquet: '✅ 默认', orc: '✅ Hive',   avro: '⚠️ 元数据', arrow: '❌',      json: '❌',       csv: '❌' },
    ],
