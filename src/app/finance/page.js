...
const [expandedCost, setExpandedCost] = useState(null);   // 展开的成本明细年份
  ...
  /* ================================================================
   *  ★ 甘特图数据：业务成果时间线 + 招聘节奏
   *  时间轴：2026H1 ~ 2030H2（10 个半年）
   *  主线1：业务成果 Milestone（按业务线）
   *  主线2：招聘计划（按部门/岗位族群）
   * ================================================================ */
  const ganttHalves = ['26H1','26H2','27H1','27H2','28H1','28H2','29H1','29H2','30H1','30H2'];
  const ganttMonths = ['2026.1-6','2026.7-12','2027.1-6','2027.7-12','2028.1-6','2028.7-12','2029.1-6','2029.7-12','2030.1-6','2030.7-12'];

  // 业务成果甘特图（每个 bar 表示一个可交付产出的开发周期）
  const ganttBizTracks = [
    {
      line: '🛡️ 风控', color: '#e17055',
      bars: [
        { start: 0, end: 1, label: '图网络反欺诈 PoC→上线', milestone: '欺诈识别率+10%' },
        { start: 2, end: 3, label: 'LLM+图网络融合 + SAR 自动生成', milestone: '全行信贷覆盖' },
        { start: 4, end: 5, label: '风控 Agent 1.0→2.0', milestone: '自主处置率>90%' },
        { start: 6, end: 7, label: '风控 SaaS + 联邦联盟 8 家', milestone: '服务费 ¥2000万/半年' },
        { start: 8, end: 9, label: '全链路 AI 风控 + SaaS 全球化', milestone: '损失率 0.03%' },
      ],
    },
    {
      line: '💬 客服', color: '#00cec9',
      bars: [
        { start: 0, end: 1, label: 'RAG 知识库→客服上线（替代20%）', milestone: '节省 ¥300万/半年' },
        { start: 2, end: 3, label: '多模态客服→替代45%', milestone: '语音+文字+图片' },
        { start: 4, end: 5, label: '业务办理 Agent→替代65%', milestone: '满意度>4.5' },
        { start: 6, end: 7, label: '情感识别+全渠道→替代70%', milestone: '节省 ¥4000万/半年' },
        { start: 8, end: 9, label: '80% AI 完成 + SaaS 输出', milestone: '节省 ¥6000万/半年' },
      ],
    },
    {
      line: '💰 理财', color: '#6c5ce7',
      bars: [
        { start: 0, end: 1, label: '投研助手 PoC→内部上线', milestone: '投研效率+30%' },
        { start: 2, end: 3, label: 'AI 理财顾问 PoC→1.0 上线', milestone: 'AUM 转化率+8%' },
        { start: 4, end: 5, label: '千人千面+自动调仓 Agent', milestone: 'AUM ¥150亿' },
        { start: 6, end: 7, label: 'AUM ¥250→400亿', milestone: '佣金 ¥2500万/半年' },
        { start: 8, end: 9, label: 'AUM ¥500亿 + 平台输出', milestone: '佣金 ¥3250万/半年' },
      ],
    },
    {
      line: '📜 合规', color: '#ffa657',
      bars: [
        { start: 0, end: 1, label: '合规知识库→基础审查辅助', milestone: '效率+30%' },
        { start: 2, end: 3, label: '合同审查 Agent→合规审查上线', milestone: '效率+60%' },
        { start: 4, end: 5, label: '监管报告自动生成→全链路 Agent', milestone: '30分钟/份' },
        { start: 6, end: 7, label: '行业标准制定 + 咨询输出', milestone: '银保监会参与' },
        { start: 8, end: 9, label: 'AI 治理示范银行 + 合规 SaaS', milestone: '10分钟/份' },
      ],
    },
    {
      line: '🏗️ AI平台', color: '#3fb950',
      bars: [
        { start: 0, end: 1, label: '大模型私有化 + AI 中台 + RAG', milestone: 'SLA 99.9%' },
        { start: 2, end: 3, label: 'Agent 框架 + 推理优化 + 联邦平台', milestone: 'QPS 500' },
        { start: 4, end: 5, label: 'Agent 平台成熟 + 内部 Copilot', milestone: 'GPU利用率>70%' },
        { start: 6, end: 7, label: 'SaaS 平台 + 集团输出 + 全球化', milestone: '推理成本-50%' },
        { start: 8, end: 9, label: 'AI 原生银行 + 全球化 SaaS', milestone: '行业标杆' },
      ],
    },
  ];

  // 招聘甘特图（按部门/岗位族群，每半年的招聘人数）
  // 数值表示该半年新增招聘人数（净增），负数表示缩编/转岗
  const ganttHiringTracks = [
    {
      dept: '🧠 ML/算法研究', color: '#6c5ce7',
      // Y1:12, Y2:20(+8), Y3:30(+10), Y4:35(+5), Y5:38(+3)
      hires: [7, 5, 4, 4, 5, 5, 3, 2, 2, 1],
      cumulative: [7, 12, 16, 20, 25, 30, 33, 35, 37, 38],
      notes: ['核心算法团队组建（P8+专家优先）','补齐P7算法工程师','多模态方向招聘','Agent/RL方向','联邦学习专家','世界模型方向','商业化算法','行业垂直模型','前沿探索','稳态维护'],
    },
    {
      dept: '⚙️ 工程开发', color: '#00cec9',
      // Y1:30, Y2:48(+18), Y3:60(+12), Y4:70(+10), Y5:78(+8)
      hires: [18, 12, 10, 8, 6, 6, 5, 5, 4, 4],
      cumulative: [18, 30, 40, 48, 54, 60, 65, 70, 74, 78],
      notes: ['AI平台+数据工程核心团队','后端+前端补齐','Agent框架团队','推理优化+联邦','Agent编排+可观测','平台成熟化','SaaS平台团队','多租户架构','全球化工程','边缘推理'],
    },
    {
      dept: '📋 产品/业务分析', color: '#3fb950',
      // Y1:12, Y2:18(+6), Y3:22(+4), Y4:24(+2), Y5:24(0)
      hires: [7, 5, 3, 3, 2, 2, 1, 1, 0, 0],
      cumulative: [7, 12, 15, 18, 20, 22, 23, 24, 24, 24],
      notes: ['产品经理+业务分析师','各业务线专属产品','AI产品运营','业务架构师','产品VP','Agent产品','商业化产品','行业解决方案PM','稳态','稳态'],
    },
    {
      dept: '🧪 测试/QA', color: '#e17055',
      // Y1:8, Y2:10(+2), Y3:14(+4), Y4:16(+2), Y5:18(+2)
      hires: [5, 3, 1, 1, 2, 2, 1, 1, 1, 1],
      cumulative: [5, 8, 9, 10, 12, 14, 15, 16, 17, 18],
      notes: ['AI模型测试+安全测试','系统集成测试','Agent评测','多模态测试','Agent端到端','安全红队','SaaS多租户','合规测试','全球化测试','量子安全'],
    },
    {
      dept: '📜 合规/风控', color: '#ffa657',
      // Y1:8, Y2:12(+4), Y3:16(+4), Y4:20(+4), Y5:30(+10)
      hires: [5, 3, 2, 2, 2, 2, 2, 2, 5, 5],
      cumulative: [5, 8, 10, 12, 14, 16, 18, 20, 25, 30],
      notes: ['合规专家+风控审计','AI伦理审查','联邦合规','Agent合规框架','安全红队','监管沙盒','行业标准','外部咨询','全球化合规','量子安全'],
    },
    {
      dept: '🔧 PMO/项目管理', color: '#a29bfe',
      // Y1:5, Y2:7(+2), Y3:10(+3), Y4:12(+2), Y5:16(+4)
      hires: [3, 2, 1, 1, 2, 1, 1, 1, 2, 2],
      cumulative: [3, 5, 6, 7, 9, 10, 11, 12, 14, 16],
      notes: ['高级PM+项目经理','协调员','联邦项目','多项目并行','Agent项目群','项目总监','客户成功','SaaS运营','全球化交付','行业标准'],
    },
    {
      dept: '🖥️ 运维/SRE', color: '#fd79a8',
      // Y1:4, Y2:7(+3), Y3:10(+3), Y4:12(+2), Y5:18(+6)
      hires: [3, 1, 2, 1, 2, 1, 1, 1, 3, 3],
      cumulative: [3, 4, 6, 7, 9, 10, 11, 12, 15, 18],
      notes: ['GPU集群运维','基础设施','H100集群','联邦平台','Agent SLA','三地两中心','SaaS运维','7×24值班','全球化NOC','边缘运维'],
    },
    {
      dept: '📊 数据标注/分析', color: '#636e72',
      // Y1:6, Y2:8(+2), Y3:8(0), Y4:6(-2转岗), Y5:8(+2)
      hires: [4, 2, 1, 1, 0, 0, -1, -1, 1, 1],
      cumulative: [4, 6, 7, 8, 8, 8, 7, 6, 7, 8],
      notes: ['数据分析师+外包标注','金融标注专家','RLHF标注','多模态标注','自动化替代','数据飞轮','转岗质检','自动化成熟','数据科学家','数据资产'],
    },
    {
      dept: '🤝 解决方案/售前', color: '#00b894',
      // Y1:0, Y2:0, Y3:0, Y4:12(+12), Y5:18(+6)
      hires: [0, 0, 0, 0, 0, 0, 6, 6, 4, 2],
      cumulative: [0, 0, 0, 0, 0, 0, 6, 12, 16, 18],
      notes: ['-','-','-','-','-','-','解决方案总监+架构师','技术售前+客户成功','全球化售前','售前协调'],
    },
  ];
  ...
  return (
    <div className="space-y-5">
      ...
      {/* ═══════════ 4.5 甘特图：业务成果 + 招聘节奏 ═══════════ */}
      <div className="bg-white rounded-2xl border border-gray-100 p-5">
        <h3 className="text-base font-semibold text-gray-800 mb-2">📊 甘特图：业务成果 × 招聘节奏（双轨并行）</h3>
        <p className="text-[11px] text-gray-400 mb-4 leading-relaxed">
          💡 <strong>核心逻辑</strong>：2026 年已过半，招聘必须有节奏——先招核心骨干（H1），再补齐团队（H2），每半年对齐业务 Milestone。
          <strong>上半部分</strong>是业务成果时间线（5 条业务线的可交付产出），<strong>下半部分</strong>是招聘计划（9 个部门的半年招聘人数）。
          两条线必须对齐：<strong>先有人，才能交付成果</strong>。
        </p>
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[900px]">
            ...
            <div className="flex items-center mb-1">
              ...
              {['Y1（2026）','Y2（2027）','Y3（2028）','Y4（2029）','Y5（2030）'].map((y, yi) => (
                <div key={y} className="flex-1 text-center text-[10px] font-mono font-bold" style={{ color: ['#6c5ce7','#00cec9','#3fb950','#ffa657','#f97316'][yi] }}>
                  {y}
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center mb-2 border-b border-gray-200 pb-1">
              ...
              {ganttHalves.map((h, hi) => (
                <div key={h} className={`flex-1 text-center text-[9px] font-mono ${hi === 0 ? 'text-red-500 font-bold' : 'text-gray-400'}`}>
                  {h}{hi === 0 ? ' ←当前' : ''}
                </div>
              ))}
            </div>
            ...
            {/* ═══ 业务成果甘特图 ═══ */}
            <div className="text-[10px] font-semibold text-gray-600 mb-1 mt-2">📌 业务成果时间线</div>
              ...
              <div key={track.line} className="flex items-center mb-1.5">
                ...
                <div className="flex-1 relative h-7">
                  ...
                  <div className="absolute inset-0 flex">
                    {ganttHalves.map((_, i) => (
                      <div key={i} className={`flex-1 ${i % 2 === 0 ? 'bg-gray-50/60' : ''} ${i === 0 ? 'border-l-2 border-red-200' : 'border-l border-gray-100'}`} />
                    ))}
                  </div>
                  {/* 甘特条 */}
                  {track.bars.map((bar, bi) => {
                    const leftPct = (bar.start / 10) * 100;
                    const widthPct = ((bar.end - bar.start + 1) / 10) * 100;
                    return (
                      <div key={bi} className="absolute top-1 h-5 rounded-md flex items-center px-1.5 overflow-hidden group"
                        style={{ left: `${leftPct}%`, width: `${widthPct}%`, background: track.color + '22', borderLeft: `3px solid ${track.color}` }}>
                        <span className="text-[8.5px] text-gray-700 truncate font-medium">{bar.label}</span>
            ...
            {/* ═══ 招聘甘特图 ═══ */}
            <div className="text-[10px] font-semibold text-gray-600 mb-1">👥 招聘节奏（每半年新增人数）</div>
                          ...
                          {h !== 0 && (
                            <>
                              <div className="absolute bottom-0.5 rounded-sm" style={{
                                width: '60%', height: `${barH}px`,
                                background: h > 0 ? track.color + '44' : '#ef444433',
                                borderBottom: h > 0 ? `2px solid ${track.color}` : '2px solid #ef4444',
                              }} />
                              <span className={`relative text-[9px] font-mono font-bold ${h > 0 ? '' : 'text-red-500'}`} style={{ color: h > 0 ? track.color : undefined }}>
                                {h > 0 ? `+${h}` : h}
                              </span>
                            </>
                          )}
                          {h === 0 && <span className="text-[8px] text-gray-300">-</span>}
                          {/* hover 提示 */}
            ...
            <div className="flex items-center mt-2 pt-2 border-t border-gray-200">
              ...
              <div className="flex-1 flex">
                {ganttHalves.map((_, hi) => {
                  const total = ganttHiringTracks.reduce((s, t) => s + t.cumulative[hi], 0);
                  return (
                    <div key={hi} className="flex-1 text-center text-[10px] font-mono font-bold text-gray-800">
                      {total}
                    </div>
                  );
                })}
        ...
        <div className="mt-4 p-3 rounded-xl bg-orange-50/40 border border-orange-100 text-[11px] text-gray-600 leading-relaxed">
          <span className="font-semibold text-orange-700">📋 招聘节奏策略（2026H1 已过半）：</span>
          <div className="mt-1 space-y-1">
            <div>• <strong>26H1（当前）</strong>：核心骨干到位——P8+ 算法专家 3 人、AI 平台架构师 1 人、高级 PM 1 人、合规专家 2 人，共 ~52 人到岗</div>
            <div>• <strong>26H2</strong>：补齐执行层——P6-P7 算法/工程/测试/标注，共 +33 人，年底达 85 人满编</div>
            <div>• <strong>27H1-H2</strong>：场景突破期扩编——Agent 框架团队、多模态团队、联邦学习团队，+45 人达 130 人</div>
            <div>• <strong>28H1-H2</strong>：Agent 化阶段——Agent 编排/可观测/安全红队/RLHF 标注，+50 人达 180 人</div>
            <div>• <strong>29H1-H2</strong>：商业化输出——新增解决方案/售前团队 12 人、SaaS 平台团队、客户成功，+37 人达 207 人</div>
            <div>• <strong>30H1-H2</strong>：全球化——全球化运维 NOC、多区域售前、合规咨询输出，+41 人达 248 人（另预留 12 人 buffer 至满编 260）</div>
          </div>
        </div>
        ...
        <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-2">
          {[
            { time: '26H1 Q1-Q2', action: '🔴 紧急招聘', detail: 'P8+ 算法专家 ×3、AI 平台架构师 ×1、首席合规专家 ×1、高级 PM ×1', reason: '核心骨干必须先到位，否则后续团队无人带' },
            { time: '26H2 Q3-Q4', action: '🟠 快速补齐', detail: 'P7 算法 ×5、后端工程师 ×8、前端 ×4、测试 ×3、数据标注 ×3', reason: '执行层到位，支撑 Y1 筑基目标交付' },
            { time: '27H1', action: '🟡 方向扩展', detail: 'Agent 框架工程师 ×4、多模态算法 ×4、业务分析师 ×3', reason: '新方向需要专业人才，提前半年招聘' },
            { time: '29H1', action: '🟢 商业化团队', detail: '解决方案总监 ×1、架构师 ×3、技术售前 ×4、客户成功 ×3', reason: 'Y4 商业化输出需要售前+交付团队' },
          ].map(m => (
