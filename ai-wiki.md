...
### 10. 导航栏 `Navbar.js`
- ✅ 改造为 **4 个分组下拉导航**，解决条目过多拥挤问题
  - 📚 **知识**：书架 · 文章 · 论文 · 模型 · 数据闭环 · 工具箱
  - 🔬 **业务**：自动驾驶 · 实验室
  - 🧭 **战略**：业务原生
  - 🌊 **动态**：AI 声浪 · 进化日志
- ✅ 桌面端：hover 展开下拉面板，每项显示名称 + 描述
- ✅ 移动端：点击分组折叠/展开子菜单
- ✅ 主行恢复单行布局（Logo 左 + 分组中 + 状态右）
...
*最后更新：2026-04-18（Navbar 改造为分组下拉导航：知识/业务/战略/动态四大分组，解决导航条目拥挤问题）*
