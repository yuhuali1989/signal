...
- ✅ **8 大 Tab**（原 4 Tab 保留并深化，新增 4 条深度支线）：
  ...
  - 🗺️ **AI 战略规划**（新增）：**平安银行金融 AI 战略部五年业务规划（2026-2030）**——部门使命/愿景 + 五年演进路线（Y1 筑基→Y2 场景突破→Y3 Agent 驱动→Y4 生态输出→Y5 AI 原生银行）+ **人力成本精细拆解**（85→250 人，5 大岗位族群，每岗位拆解为基本工资/绩效奖金(0-8个月)/股权RSU/综合福利(五险一金+商业保险+工位租金3-5万+餐补交通2-3万+团建差旅)，P8+ 专家 250 万起/P9 级 400-500 万/首席科学家 600 万+，五年人力合计约 ¥10.6 亿）+ **硬件基础设施预算明细**（GPU训练/推理集群+存储+网络+隐私计算+灾备等 8 项，含规格/占比/说明，五年合计约 ¥3.4 亿）+ **外部采购明细**（商业API+隐私计算+数据源+咨询审计+培训 5 项）+ **营收&节省成本精细拆解**（每项含计算公式+置信度标注，节省成本=人力替代+损失降低，增量营收=佣金+服务费+SaaS+解决方案）+ **四大业务线目标拆解**（风控/客服/理财/合规，每条线 5 年里程碑 + 核心指标 baseline→target）+ **ROI 测算总表**（年度/累计 ROI 自动计算 + 可视化条形图，五年累计投入约 ¥14.7 亿 vs 回报约 ¥14.0 亿，Y3 接近盈亏平衡）+ **关键风险与应对**（5 大风险 + 影响/应对策略）+ **组织架构**（Y3 成熟态 7 个小组 180 人编制）+ 人力/营收明细支持展开/收起交互
