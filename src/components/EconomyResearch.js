...
// 数据来源：frankfurter.app（基于欧洲央行参考汇率），2026-04 为最新实时数据
const USD_CNY_HISTORY = [
  // 2020
  { period: '20-01', rate: 6.9367, note: '疫情初期，人民币小幅承压' },
  { period: '20-02', rate: 6.9839, note: '疫情扩散，避险美元走强' },
  { period: '20-03', rate: 7.0997, note: '全球流动性危机，美元急涨' },
  { period: '20-04', rate: 7.049,  note: '美联储无限 QE，美元回落' },
  { period: '20-05', rate: 7.1351, note: '中美关系紧张，人民币承压' },
  { period: '20-06', rate: 7.0744, note: '中国经济率先复苏' },
  { period: '20-07', rate: 6.9748, note: '出口强劲，人民币升值' },
  { period: '20-08', rate: 6.8435, note: '美元指数持续走弱' },
  { period: '20-09', rate: 6.809,  note: '人民币升值加速' },
  { period: '20-10', rate: 6.6813, note: '美国大选前美元走弱' },
  { period: '20-11', rate: 6.5775, note: '拜登当选，美元大跌' },
  { period: '20-12', rate: 6.5378, note: '年底人民币升至两年高位' },
  // 2021
  { period: '21-01', rate: 6.431,  note: '人民币升值惯性延续' },
  { period: '21-02', rate: 6.4669, note: '美债收益率上行，美元反弹' },
  { period: '21-03', rate: 6.5511, note: '美联储缩表预期升温' },
  { period: '21-04', rate: 6.467,  note: '美元回落，人民币反弹' },
  { period: '21-05', rate: 6.3701, note: '出口超预期，人民币强势' },
  { period: '21-06', rate: 6.4576, note: '美联储鹰派信号，美元反弹' },
  { period: '21-07', rate: 6.4619, note: '德尔塔疫情扰动' },
  { period: '21-08', rate: 6.4615, note: '美联储 Jackson Hole 会议' },
  { period: '21-09', rate: 6.464,  note: '恒大危机，人民币小幅承压' },
  { period: '21-10', rate: 6.3966, note: '出口旺季，人民币走强' },
  { period: '21-11', rate: 6.3711, note: '奥密克戎出现，避险情绪' },
  { period: '21-12', rate: 6.3524, note: '年底出口结汇，人民币偏强' },
  // 2022
  { period: '22-01', rate: 6.361,  note: '人民币延续强势' },
  { period: '22-02', rate: 6.3104, note: '俄乌冲突前，人民币升值' },
  { period: '22-03', rate: 6.342,  note: '俄乌冲突 + 美联储首次加息' },
  { period: '22-04', rate: 6.5883, note: '上海封控，人民币急贬' },
  { period: '22-05', rate: 6.665,  note: '美联储激进加息预期升温' },
  { period: '22-06', rate: 6.703,  note: '美联储加息 75bp，美元强势' },
  { period: '22-07', rate: 6.7371, note: '美元指数突破 107' },
  { period: '22-08', rate: 6.8947, note: '美元指数突破 110，人民币承压' },
  { period: '22-09', rate: 7.1161, note: '美元指数 114，人民币破 7' },
  { period: '22-10', rate: 7.3008, note: '美元指数高位，人民币历史低位' },
  { period: '22-11', rate: 7.0776, note: '美联储加息放缓预期，美元回落' },
  { period: '22-12', rate: 6.8987, note: '防疫政策转向，人民币反弹' },
  // 2023
  { period: '23-01', rate: 6.7569, note: '重新开放预期，人民币大涨' },
  { period: '23-02', rate: 6.9369, note: '经济复苏不及预期' },
  { period: '23-03', rate: 6.8748, note: '硅谷银行危机，避险情绪' },
  { period: '23-04', rate: 6.9191, note: '中美利差扩大，资本外流' },
  { period: '23-05', rate: 7.1072, note: '美债上限危机，美元走强' },
  { period: '23-06', rate: 7.2688, note: '人民币跌破 7.2，央行出手' },
  { period: '23-07', rate: 7.1494, note: '央行逆周期因子调节' },
  { period: '23-08', rate: 7.2871, note: '美元指数反弹，人民币再承压' },
  { period: '23-09', rate: 7.3015, note: '美联储高利率维持更久预期' },
  { period: '23-10', rate: 7.3158, note: '以巴冲突，避险美元走强' },
  { period: '23-11', rate: 7.1364, note: '美联储加息结束预期，美元回落' },
  { period: '23-12', rate: 7.1049, note: '年底汇率企稳' },
  // 2024
  { period: '24-01', rate: 7.1781, note: '降息预期推迟，美元反弹' },
  { period: '24-02', rate: 7.1945, note: '美国通胀超预期，美元走强' },
  { period: '24-03', rate: 7.2282, note: '美联储维持高利率' },
  { period: '24-04', rate: 7.241,  note: '中东局势紧张，避险美元' },
  { period: '24-05', rate: 7.2408, note: '美联储降息预期再推迟' },
  { period: '24-06', rate: 7.2628, note: '欧央行率先降息，美元走强' },
  { period: '24-07', rate: 7.2215, note: '日元套利交易平仓，美元波动' },
  { period: '24-08', rate: 7.088,  note: '美联储降息预期升温，美元走弱' },
  { period: '24-09', rate: 7.0124, note: '美联储降息 50bp，人民币升值' },
  { period: '24-10', rate: 7.116,  note: '特朗普选情领先，美元反弹' },
  { period: '24-11', rate: 7.2414, note: '特朗普当选，关税预期，人民币承压' },
  { period: '24-12', rate: 7.2994, note: '美联储鹰派降息，美元走强' },
  // 2025
  { period: '25-01', rate: 7.2513, note: '特朗普就职，关税政策落地预期' },
  { period: '25-02', rate: 7.279,  note: '关税摩擦持续，人民币承压' },
  { period: '25-03', rate: 7.2531, note: '美联储暂停降息，美元偏强' },
  { period: '25-04', rate: 7.2659, note: '对等关税宣布，人民币承压' },
  { period: '25-05', rate: 7.1943, note: '中美贸易谈判，人民币反弹' },
  { period: '25-06', rate: 7.1647, note: '美联储降息预期升温' },
  { period: '25-07', rate: 7.1947, note: '美元指数震荡' },
  { period: '25-08', rate: 7.1329, note: '全球经济放缓担忧' },
  { period: '25-09', rate: 7.1196, note: '美联储降息 25bp' },
  { period: '25-10', rate: 7.1162, note: '人民币温和升值' },
  { period: '25-11', rate: 7.0756, note: '美元指数走弱' },
  { period: '25-12', rate: 7.001,  note: '年底人民币升至 7.0 附近' },
  // 2026
