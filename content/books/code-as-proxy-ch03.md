...
Palantir 的客户包括：
- **美国国防部**：处理 IL6（机密级，SECRET）级别的情报数据
- **CIA / NSA**：反恐情报分析
- **NATO**：跨国军事协调
...
**Palantir AIP 是率先获得 IL6 部署资质的商业产品。** 这不是因为它的加密更强，而是因为 Code as Proxy 架构从根本上消除了数据泄露的可能性。
...
| **安全级别** | 率先获得 IL6（机密级，SECRET）部署资质的商业产品 |
