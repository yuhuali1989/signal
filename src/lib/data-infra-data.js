  ...
  tableFormat: {
    ...
    icebergSpecVersions: [
      ...
      },
      {
        ...
        color: '#a29bfe',
        status: '🚧 规范已定，引擎逐步落地',
        released: '2024（Spec 定稿），Iceberg 1.7+ 实验性支持',
        ...
        engineSupport: [
          { engine: 'Spark', support: '🚧 进行中', version: 'Spark 4.0（预计 2025 Q3）', note: 'Variant 类型、DV 优先落地' },
          { engine: 'Flink', support: '🚧 进行中', version: 'Flink 2.1+（预计 2025 Q4）', note: 'Row Lineage 支持在规划中' },
          { engine: 'Trino', support: '🚧 进行中', version: 'Trino 450+（预计 2025 Q3）', note: 'DV 读取优先，Variant 后续' },
          { engine: 'DuckDB', support: '🔜 规划中', version: '预计 2026 Q1', note: 'Variant 类型对接 JSON 生态' },
          { engine: 'StarRocks', support: '🔜 规划中', version: '预计 2025 Q4', note: 'DV + Row Lineage 优先' },
          { engine: 'PyIceberg', support: '🚧 进行中', version: 'PyIceberg 0.9+（预计 2025 Q3）', note: 'Python 侧 Variant 读写支持' },
        ],
        upgradeNotes: [
